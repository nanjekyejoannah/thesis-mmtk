...
class MMTKGenCopyGC(MovingGCBase):
    ...
    def collect_roots_in_nursery(self):
        ...
        self.root_walker.walk_roots(
            MMTKGenCopyGC._trace_drag_out1,  # stack roots
            MMTKGenCopyGC._trace_drag_out1,  # static in prebuilt non-gc
    ...
    def collect_roots(self):
        ...
        self.root_walker.walk_roots(
            MMTKGenCopyGC._collect_ref_stk, # stack roots
            MMTKGenCopyGC._collect_ref_stk, # static in prebuilt non-gc structures
